...
export const ART_STYLES = [
  ...
  'Dark Souls I style: grimdark decayed medieval-gothic ruins as primary aesthetic, orange amber and grey restricted color palette creating dread, corrupted crumbling stone architecture with architectural decay, grotesque undead creatures with detailed monstrous anatomy, flickering torch lighting with dynamic shadow play, thick mist and fog effects obscuring distance, heavy shadow areas with rare highlights, souls-like glowing eyes piercing darkness, environmental storytelling through broken statues and fallen grandeur, oppressive atmospheric dread permeates entire composition',
